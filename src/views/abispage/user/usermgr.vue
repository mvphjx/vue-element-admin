<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.roleName" :placeholder="$t('table.roleName')" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
      ...
      <el-checkbox v-model="showRoleName" class="filter-item" style="margin-left:15px;" @change="tableKey=tableKey+1">{{ $t('table.roleName') }}</el-checkbox>
    </div>
    ...
    >
      ...
      <el-table-column v-if="showRoleName" :label="$t('table.roleName')" width="110px" align="center">
        <template slot-scope="scope">
          <span style="color:red;">{{ scope.row.roleName }}</span>
        </template>
      </el-table-column>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        userName: [{ required: true, message: this.$t('table.userName') + ' is required', trigger: 'blur' }]
      },
